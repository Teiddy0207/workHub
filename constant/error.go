...
var (
	...
	ErrCannotDeleteUserWithActiveBorrows = errors.New("cannot delete user with active borrows")
	ErrBookNotFound                    = errors.New("book not found")
	ErrISBNAlreadyExists               = errors.New("ISBN already exists")
	ErrNoAvailableCopies               = errors.New("no available copies")
	ErrCannotDeleteBookWithActiveBorrows = errors.New("cannot delete book with active borrows")
	ErrUserHasMaxBorrows               = errors.New("user has reached maximum borrows limit")
	ErrBookAlreadyBorrowed             = errors.New("book already borrowed by this user")
	ErrBorrowNotFound                  = errors.New("borrow not found")
	ErrBorrowAlreadyReturned           = errors.New("borrow already returned")
	ErrInvalidDaysToBorrow             = errors.New("invalid days to borrow")
)
